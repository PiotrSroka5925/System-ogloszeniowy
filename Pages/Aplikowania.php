              ...
              if ($dataWaznosci > $dzis) {                                     
                ...
                <div class="col-12 d-flex justify-content-center">
                    <a href="SzczegolyOglo.php?id='.$ogloszenie['ogloszenie_id'].'" class="ogloszenieMain my-3 border-0 rounded-4 shadow-lg px-3 row text-decoration-none">
                      ...
                      <form method="post" class="col-12 col-xl-3">                 
                        <input type="submit" class="btn UlubionyKolor btn-secondary text-light col-12 border-3 rounded-5 px-5 my-3" name="usuwanieAplikowanie" value="Przestań aplikować">
                        <input type="number" value="'.$ogloszenie['ogloszenie_id'].'" name="ukrytyAplikowanie" hidden>
                      </form> 
                    </a>                     
                  </div>';              
              }
