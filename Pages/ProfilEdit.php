...
<html lang="pl">
  ...
  <body class="d-flex flex-column min-vh-100">    
      <nav class="navbar navbar-expand-lg bg-dark shadow-lg" data-bs-theme="dark">    
        <a href="StronaGlowna.html" class="border border-dark"><img src="Images/logo.png" class="d-none d-sm-block border border-dark" alt="logo"></a>
        <a class="navbar-brand fs-3 fw-bold" href="StronaGlowna.html">MoonWork</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item" id="stronaglowna">
              <a class="nav-link active mt-1 fs-5 marginChange" aria-current="page" href="StronaGlowna.html">Strona główna</a>
            </li>                          
