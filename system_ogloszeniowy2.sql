...
--
-- Host: 127.0.0.1
-- Czas generowania: 06 Lis 2023, 10:18
...
CREATE TABLE `ogloszenie` (
  ...
  `adres_firmy_id` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `ogloszenie_adres_firmy`
--

CREATE TABLE `ogloszenie_adres_firmy` (
  `adres_firmy_id` int(10) UNSIGNED NOT NULL,
...
ALTER TABLE `ogloszenie`
  ...
  ADD KEY `adres_firmy_id` (`adres_firmy_id`);

--
-- Indeksy dla tabeli `ogloszenie_adres_firmy`
--
ALTER TABLE `ogloszenie_adres_firmy`
  ADD PRIMARY KEY (`adres_firmy_id`);
...
--
-- AUTO_INCREMENT dla tabeli `aplikacja`
--
ALTER TABLE `aplikacja`
  MODIFY `aplikacja_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `frima`
--
ALTER TABLE `frima`
...
--
-- AUTO_INCREMENT dla tabeli `ogloszenie_adres_firmy`
--
ALTER TABLE `ogloszenie_adres_firmy`
  MODIFY `adres_firmy_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `ogloszenie_stanowisko`
--
ALTER TABLE `ogloszenie_stanowisko`
...
--
-- AUTO_INCREMENT dla tabeli `uzytkownik_dodatkowe_szkolenia`
--
ALTER TABLE `uzytkownik_dodatkowe_szkolenia`
  MODIFY `szkolenie_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `uzytkownik_doswiadczenie_zawodowe`
--
ALTER TABLE `uzytkownik_doswiadczenie_zawodowe`
  MODIFY `doswiadczenie_zawodowe_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `uzytkownik_linki`
--
ALTER TABLE `uzytkownik_linki`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `uzytkownik_miejsce_zamieszkania`
--
ALTER TABLE `uzytkownik_miejsce_zamieszkania`
  MODIFY `miejsce_zamieszkania_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `uzytkownik_stanowisko_pracy`
--
ALTER TABLE `uzytkownik_stanowisko_pracy`
  MODIFY `stanowisko_pracy_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `uzytkownik_wykszatlcenie`
--
ALTER TABLE `uzytkownik_wykszatlcenie`
  MODIFY `wykszatlcenie_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `uzytkownik_znajomosc_jezykow`
--
ALTER TABLE `uzytkownik_znajomosc_jezykow`
...
--
-- Ograniczenia dla tabeli `ogloszenie_adres_firmy`
--
ALTER TABLE `ogloszenie_adres_firmy`
  ADD CONSTRAINT `ogloszenie_adres_firmy_ibfk_1` FOREIGN KEY (`adres_firmy_id`) REFERENCES `ogloszenie` (`adres_firmy_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ograniczenia dla tabeli `ogloszenie_stanowisko`
--
ALTER TABLE `ogloszenie_stanowisko`
...
--
-- Ograniczenia dla tabeli `uzytkownik_dodatkowe_szkolenia`
--
ALTER TABLE `uzytkownik_dodatkowe_szkolenia`
...
--
-- Ograniczenia dla tabeli `uzytkownik_doswiadczenie_zawodowe`
--
ALTER TABLE `uzytkownik_doswiadczenie_zawodowe`
...
--
-- Ograniczenia dla tabeli `uzytkownik_miejsce_zamieszkania`
--
ALTER TABLE `uzytkownik_miejsce_zamieszkania`
...
--
-- Ograniczenia dla tabeli `uzytkownik_stanowisko_pracy`
--
ALTER TABLE `uzytkownik_stanowisko_pracy`
...
--
-- Ograniczenia dla tabeli `uzytkownik_wykszatlcenie`
--
ALTER TABLE `uzytkownik_wykszatlcenie`
...
--
-- Ograniczenia dla tabeli `uzytkownik_znajomosc_jezykow`
--
ALTER TABLE `uzytkownik_znajomosc_jezykow`
